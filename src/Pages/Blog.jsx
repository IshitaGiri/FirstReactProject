    ...
    <div className="row">
      ...
      <div className="col-lg-8 entries">
        ...
        <article className="entry" data-aos="fade-up">
          ...
          <div className="entry-content">
            ...
            <div className="read-more">
              <Link to="/blogsingle">Read More</Link>
            </div>
          </div>
        ...
        <article className="entry" data-aos="fade-up">
          ...
          <h2 className="entry-title">
            <Link to="//blogsingle">Nisi magni odit consequatur autem nulla dolorem</Link>
          </h2>
        ...
        <article className="entry" data-aos="fade-up">
          ...
          <h2 className="entry-title">
            <a href="/blogsingle">Possimus soluta ut id suscipit ea ut. In quo quia et soluta libero sit sint.</a>
          </h2>
        ...
        <article className="entry" data-aos="fade-up">
          ...
          <h2 className="entry-title">
            <Link to="/blogsingle">Non rem rerum nam cum quo minus. Dolor distinctio deleniti explicabo eius exercitationem. Veniam eius velit ab ipsa quidem rem.</Link>
          </h2>
